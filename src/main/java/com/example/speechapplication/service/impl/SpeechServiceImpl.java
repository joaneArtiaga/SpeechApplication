package com.example.speechapplication.service.impl;
...
import com.example.speechapplication.service.AuthorService;
import com.example.speechapplication.service.SpeechService;
import com.example.speechapplication.service.SubjectService;
    ...
    public List<Speech> findBySubject(String subject) {
        try {
            ...
            if (subj != null) {
                ...
                if(allSpeech.isEmpty()){
                    throw new SpeechCustomException("There is no speech with subject area " + subject,
    ...
    public List<Speech> findByAuthor(String firstname, String lastname) {
        try {
            ...
            if (author != null) {
                ...
                if(allSpeech.isEmpty()){
                    throw new SpeechCustomException("There is no speech with author " + firstname +
                      " " + lastname, HttpStatus.FOUND.value());
                }
                return allSpeech;
            } else {
